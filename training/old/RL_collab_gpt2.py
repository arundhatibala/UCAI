...
model = AutoModelForSequenceClassification.from_pretrained("supervised_gpt2", local_files_only=True)

config = PPOConfig(
    model_name=model,#,"meta-llama/Llama-2-7b-hf",#"bigcode/tiny_starcoder_py",#"TinyLlama/TinyLlama-1.1B-Chat-v0.6",
